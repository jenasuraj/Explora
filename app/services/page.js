  ...
  return (
     ...
     data-aos-duration="3000">
        <article className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6 text-white">Why Choose Explora.ai?</h2>
          <p className="text-lg mb-8 leading-relaxed text-white">
            ...
            that are uniquely tailored to you. Whether its a relaxing getaway or an adventurous escape,
