...
const Section4 = () => {
  return (
    ...
    <section className="min-h-[70vh] w-10/12 max-w-7xl  mx-auto  mt-10 text-white shadow-sm rounded-t-3xl rounded-b-2xl  py-10 flex flex-col md:flex-row items-center justify-between gap-10" data-aos="fade-up" data-aos-duration="3000">
      {/* Text Section */}
      <header className="text-center md:text-left md:w-1/2 space-y-4">
        ...
        <p className="text-base sm:text-lg text-gray-400  text-center leading-relaxed md:text-left">
