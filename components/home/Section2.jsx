...
const Section2 = () => {
  return (
    ...
    <section className="min-h-[70vh] w-10/12 max-w-7xl mx-auto mt-10 bg-white shadow-sm rounded-t-3xl rounded-b-2xl px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-10" data-aos="fade-up"
